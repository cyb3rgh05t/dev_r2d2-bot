        ...
        switch (SubCommand) {
            ...
            case "lock": {
                ...
                DB.findOne({ChannelID: channel.id}, async (err, data) => {
                    ...
                    Embed.setDescription(`<:approved:941879734768398337> This ticket is now locked for reviewing`).setColor("GREEN");
            ...
            case "unlock": {
                DB.findOne({ChannelID: channel.id}, async (err, data) => {
                    ...
                    Embed.setDescription(`<:approved:941879734768398337> This ticket has been unlocked`).setColor("GREEN");
                    interaction.editReply({embeds: [Embed]});
                })
            }
            break;
