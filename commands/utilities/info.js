                    ...
                    .addFields(
                        {
                            ...
                            **\`•\` Explicit Filter**: ${explicitFilter[guild.explicitContentFilter] || "None"}
                            ...
                            name: "<:icon_reply:993231553083736135> 👥 MEMBERS: ",
                            value:
                            `
                            ...
                            **\`•\` Bots**: ${guild.members.cache.filter((m) => m.user.bot).size}
                            ...
                            name: "<:icon_reply:993231553083736135> 💬 CHANNELS: ",
                            value:
                            `
                    ...
                    if (channel.type !== "GUILD_VOICE") {
                        ...
                        .addFields({
                            ...
                            **\`•\` Created**: <t:${parseInt(channel.createdTimestamp / 1000)}:R>
                            ...
                            name: "<:icon_reply:993231553083736135> THREADS: ",
                            value: 
                            `
                            **\`•\` Active Threads**: ${channel.threads.cache.size || "None"}
                            ...
                            name: "<:icon_reply:993231553083736135> WEBHOOKS: ",
                            value:
                            `
                        ...
                        .addFields({
                            ...
                            **\`•\` Created**: ${moment(channel.createdAt).format("MMMM Do YYYY")} (${moment(channel.createdAt).startOf("day").fromNow()})
                            ...
                            name: "<:icon_reply:993231553083736135> VC: ",
                            value: 
                            `
